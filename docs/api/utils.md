...
| 模块                                       | 类  | 函数 |
| ------------------------------------------ | --- | ---- |
| [`utils.box_geometry`](#utilsbox_geometry) | 0   | 2    |
...
| `parse_color(color_str: Union[str, tuple]) -> Tuple[int, int, int]`                                                                                                                                                                          | 解析颜色 'r,g,b' 或 (r,g,b) 为整数元组                                            |
...
#### `process_page_batch(pdf_path: str, page_indices: List[int], out_dir: str, zoom: float, ext: str, quick: bool=False, progress: dict=None) -> List[bool]`
...
#### `run_on_input_directory(input_path: str, out_root: str, zoom: float=1, ext: str='jpg', workers: int=4, quick: bool=False, pages: str=None, start: int=None, end: int=None, batch_size: int=4, clean: bool=False, subdir_name: str='images')`
